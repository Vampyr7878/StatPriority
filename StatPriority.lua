...
statPriorityStats["MONKMistweaver"] = "Intellect > Haste > Critical Strike = Mastery > Versatility"
...
statPriorityStats["DEATHKNIGHTFrost"] = "Critical Strike > Mastery > Haste > Versatility"
